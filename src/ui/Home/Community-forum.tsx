...
import chatData from '../../../public/chatting.json';
...
const Community = (props: Props) => {
  return (
    <>
      <div className='w-full mt-14 h-screen flex flex-between text-center flex-row-reverse'>
        <div className='w-[50%] mx-auto mt-24'>
          <Lottie animationData={chatData} />
        </div>
        <div className='w-[50%] '>
            ...
            >
              <div className="relative overflow-hidden h-full rounded-2xl transition duration-200 group bg-white hover:shadow-xl border border-zinc-100">
                ...
                <div className="p-4">
                  ...
                  Welcome to our Marvel Avengers Community Forum, the ultimate hub for Marvel fans to unite, discuss, and dive deep into the Marvel Universe! Join fellow enthusiasts in vibrant conversations, share theories, fan art, and excitement about all things Marvel. From dissecting the latest movies and TV shows to reminiscing about classic comic book moments, this forum is your virtual hangout spot to enhance your fandom experience. Connect with like-minded fans, stay updated on news and events, and let your inner superhero thrive in our inclusive and engaging community. Embrace your inner Avenger and embark on an epic journey through the Marvel multiverse with us!
                  </h2>
                  <div className="flex flex-row justify-between items-center mt-10">
                    <div className="relative z-10 px-6 py-2 bg-black text-white font-bold rounded-xl block text-xs">
                      <Link className='text-white' target='_blank' href={"/Community"}>Take Community & Explore Merchandise</Link>
                    </div>
                  </div>
                </div>
              </div>
